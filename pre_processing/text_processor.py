...
class TextProcessor:
    ...
    def _clean_text(self, text):
        ...
        text = emoji.demojize(text)                        # Expand emojis
    ...
    def process_text(self, text):
        ...
        stemmed = self._apply_stemming(filtered)
        lemmatized = self._apply_lemmatizer(stemmed)
        return lemmatized

processor = TextProcessor()
text = "I'm loving the new India 🇮🇳! History's amazing — 5000 years of culture!"
